...
export default function DeliveryPage() {
  ...
  // Get quotes for delivery page with server-side pagination (1 per page)
  const { data: quotesData, isLoading: quotesLoading } = useQuotesQuery(currentPage, 1, { status: 'delivered' });
  ...
  return (
    <ProtectedRoute allowedRoles={['quote_creator', 'price_manager', 'quality_controller', 'admin']}>
      <div className="py-6">
        ...
        <p className="text-gray-600 mb-6">View and manage delivery quotes.</p>
        <QuoteTable
