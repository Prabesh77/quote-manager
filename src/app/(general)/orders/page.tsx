...
export default function OrdersPage() {
  ...
  // Get quotes for orders page with server-side pagination (1 per page)
  const { data: quotesData, isLoading: quotesLoading } = useQuotesQuery(currentPage, 1, { status: 'ordered' });
