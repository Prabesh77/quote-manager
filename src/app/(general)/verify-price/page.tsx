...
export default function VerifyPricePage() {
  ...
  // Get quotes for verify price page with server-side pagination
  ...
  const markQuoteCompleted = async (id: string) => {
    try {
      ...
      try {
        console.log('🎯 COMPLETED (Verify Price Page): Tracking completion action for quote:', id);
        ...
        console.log('✅ COMPLETED (Verify Price Page): Successfully tracked completion action for quote:', id);
      } catch (trackingError) {
